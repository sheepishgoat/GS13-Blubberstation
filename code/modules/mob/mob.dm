...
/atom/proc/prepare_huds()
	...
	for(var/hud in hud_possible)
		...
		if(hint == HUD_LIST_LIST)
			...
			var/image/I = image('modular_gs/icons/mob/huds/hud.dmi', src, "") // BUBBER EDIT - Original path 'icons/mob/huds/hud.dmi'	// GS13 EDIT: original modular_zubbers/icons/mob/huds/hud.dmi
