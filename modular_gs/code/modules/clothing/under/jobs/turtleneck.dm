/obj/item/clothing/under/dual_tone/turtleneck
...
/obj/item/clothing/under/dual_tone/turtleneck/add_modular_overlay(mob/living/carbon/user, modular_icon, modular_layer, sprite_color, organ_slot)
