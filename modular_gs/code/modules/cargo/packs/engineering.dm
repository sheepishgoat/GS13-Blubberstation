...
/datum/supply_pack/engineering/pipe_scrubber
	name = "Pipe scrubbers"
	desc = "Accidentally connected your freezer to a completely unrelated pipenet? With this pipe scrubber, cleaning pipes of unwanted gasses will be childs play!"
	cost = CARGO_CRATE_VALUE * 6
	contains = list(/obj/machinery/portable_atmospherics/pipe_scrubber)
	crate_name = "Pipe scrubbers supply crate"
